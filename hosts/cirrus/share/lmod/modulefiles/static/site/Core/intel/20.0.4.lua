...
prepend_path("PATH", pathJoin(swroot, "debugger_2020/gdb/intel64/bin"))
prepend_path("PATH", pathJoin(swroot, "bin"))

prepend_path("NLSPATH", pathJoin(swroot, "debugger_2020/gdb/intel64/share/locale/%l/LC_MESSAGES/%N"))
