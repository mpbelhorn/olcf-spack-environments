...
class Paraview(CMakePackage):
    ...
    def url_for_version(self, version):
        ...
        if version < Version('5.1.0'):
            return self._urlfmt.format(version.up_to(2), version, '-source', 'gz')
        elif version < Version('5.6.1'):
            return self._urlfmt.format(version.up_to(2), version, '', 'gz')
        else:
            return self._urlfmt.format(version.up_to(2), version, '', 'xz')
